...
type FAQMessages = Record<string, CategoryData>;

const FAQItem = ({ question, answer }: { question: string; answer: string }) => {
    return (

        <details className="group border-b border-gray-200 last:border-0">
            <summary className="flex cursor-pointer items-center justify-between py-6 text-lg font-medium text-gray-900
            hover:text-blue-600/80 transition-colors list-none">
                {question}
                <span className="ml-6 flex h-7 w-7 items-center justify-center rounded-full border
                border-gray-400/30 bg-transparent transition-all group-open:rotate-180">
                    <svg className="h-4 w-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                    </svg>
                </span>
            </summary>
            <div className="pb-6 text-base leading-relaxed text-gray-600 animate-in slide-in-from-top-2 fade-in duration-200">
                {answer}
            </div>
        </details>
    );
...
export default function FAQClientPage() {
    ...
    return (
        <main className="min-h-screen bg-white font-sans selection:bg-blue-100 selection:text-blue-900">
            ...
            {/* Header Section */}
            <section className="pt-30 pb-16 px-6 bg-gray-50 border-b border-gray-200 ">
                <div className="max-w-3xl mx-auto text-center space-y-6">
                    ...
                    <div className="relative max-w-xl mx-auto mt-8 group">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <svg className="h-5 w-5 text-gray-400 group-focus-within:text-blue-600 transition-colors"
                        ...
                        <input
                            ...
                            className="block w-full pl-11 pr-4 py-4 bg-white  border-gray-200 rounded-xl
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between ">
                                        ...
                                        <button
                                            ...
                                            className="text-sm text-blue-600 hover:underline pl-5 cursor-pointer"
                                        >
                                            Clear Search
                                        </button>
                                    </div>
                                    <div className="h-px w-full  bg-linear-to-br from-orange-400 to-purple-700" />
